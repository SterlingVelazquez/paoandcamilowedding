...
export default function Home() {
  ...
  function Fade(props) {
    ...
    return (
      <div
        className={`fade-in-section ${isVisible || (typeof domRef.current !== "undefined" &&
    ...
    <div className="container">
      ...
      <main className="main-wrapper">
        ...
        <div className="eventDiv">
          <Fade><div className="eventHeaderSection">
          ...
          <div className="eventGrid">
            <div className="event">
              ...
              <div className="smallBorder"></div></Fade>
            </div>
            <div className="event">
              <Fade><div className="iconBox">
                <div className="iconHolder">
          ...
          <Fade><div className="slideshowDiv">
        ...
        <div className="locationDiv">
          ...
          <div className="eventHeaderSection">
            <Fade><p className="eventHeader">When &amp; Where</p>
            <img className="eventHeaderImage" src="images/rose-icon-01.png"></img></Fade>
          </div>
          <Fade><div className="eventGrid">
          ...
          <p className="googlemapsp"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127450.10983778453!2d-76.59587550763219!3d3.3950618568448467!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e30a6f0cc4bb3f1%3A0x1f0fb5e952ae6168!2sCali%2C%20Valle%20del%20Cauca%2C%20Colombia!5e0!3m2!1sen!2sus!4v1615692973940!5m2!1sen!2sus" 
            className="googlemap" allowFullScreen="" loading="lazy"></iframe></p></Fade>
        </div>
      </main>
